...
students leave their statistics service courses. \allison{NEW} Moreover, data science 
workshops, such as these, open to the larger academic community promote the
continued learning of the computational tools necessary for working with data,
and provide resources for incorporating data science into the classroom.
...
\texttt{$\text{for}\small(\small) \small\{ \small\}$} loops. \allison{NEW} In
...
\todo{How to get the text of if(){} to be the same as ifelse()?}
