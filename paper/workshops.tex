...
% Many participants elected to return for the subsequent workshops, but nearly 70\% only attended the \emph{Introduction to \texttt{R}} workshop. 

% Maybe they didn't return because they needed a more specialize workshop than the general 
% data wrangling and data visualization workshops? 

% Desire for specialized workshops, potential for future workshop development
...
% Sustainability discussion on length of workshop and how spread out the workshops are 
...
% The sentiments heard by these faculty unearth the possibilty 
% that many faculty may be largely unaware of the computing skills necessary 
