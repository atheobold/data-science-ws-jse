...
skills necessary for scientific research and the computing skills with which students 
leave their statistics service courses. Open to faculty, staff, and the 
larger community, these workshops promote continued learning of the computational tools
...
\stacey{I still find this sentence contradictory, perhaps because "domain-tailored"
and "tailoring these workshops to specific populations of researchers" seem so similar.}
...
used the skills identified during phase one to tailor currently existing Data Carpentry 
(\citeyear{data-carpentry}) and Software Carpentry 
(\citeyear{software-carpentry}) lessons to this population. Section \ref{sec:implement} chronicles
...
skills. The full interview protocol is available as supplementary material\footnote{Materials
associated with this manuscript are available at: anonymous 
website}.
...
\stacey{The citation is from 2019; should we cite the year in which the
lesson was examined?}
...
research are available through GitHub\footnote{Anonymous GitHub link}, 
% \href{https://github.com/atheobold/data-science-workshops-jse}{GitHub
% repository (link)}}
with video tutorials recorded and available through our institution's library\footnote{Anonymous YouTube link}. 
...
\subsection{Pedagogy}
\stacey{Didn't we used to have a section that talked about how the workshops were taught?
I think we should add this back in - talk about the active learning classroom, participants
bring their own laptops, using sticky notes, inter-weaving short instructional lectures with
hands-on practice and challenges, etc.}
...
(RStudio and RStudio Cloud), user-friendly \texttt{R} packages for data wrangling and
data visualization (\texttt{tidyverse}),
and tools that promote reproducibility throughout
...
together.
\stacey{I'm not following this sentence. What "groups" are we summarizing?
...
the post-workshop survey. The submission of these surveys required responses to every
question. The pre- and post-workshop surveys are available
...
\noindent \stacey{Add sentence: To date, we have held XX workshops, serving XX members
of the Anonymous University community.} To facilitate the sustainability of these workshops, we forged a
...
future graduate student instructors. Instructors were recruited from the Master's
and Doctoral programs in Statistics, but because of the widespread use of 
\texttt{R} across scientific fields, graduate students from a variety of backgrounds also hold
...
instructing. Each semester, instructor trainees taught different 30 to 45 minute portions
...
\quad Similar to the Explorations in Statistics Research\stacey{Should this be in quotes?} workshop model
...
be tailored towards busy students, faculty, and staff---by offering one 3-hour workshop
every few weeks---but this
