...
general concept \citep[p.\ 95]{miles}. During this stage, skills were linked thematically, and 
categories that held across multiple interviews were retained. Next, the author
...
a key aspect to working with data in \texttt{R}, faculty sentiments regarding 
the need for students' work to be reproducible was not voiced alongside a
specific software.
...
% categories of data wrangling, and data visualization created. 
...
workshop introduces the \texttt{dplyr} \citep{dpylr} and \texttt{tidyr} 
...
% paid to understanding the backgrounds of the workshop attendees and their
% experiences in each workshop. Evaluating the learning outcomes of these
% workshops is left as future research. 
...
% Numerous participants expressed that ``[in their field] the value of
% learning \texttt{R} cannot be underestimated,'' because ``[\texttt{R}] is an
% essential tool for researchers.'' A number of graduate students reflected on the
% importance of these workshops ``filling a critical hole in the curriculum of
